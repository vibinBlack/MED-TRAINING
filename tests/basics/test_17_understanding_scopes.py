...
def test_scope_is_bound_at_definition_time():
    ...
    try:
        value = count
        count = 30
    except UnboundLocalError as ex: #  local variable 'count' referenced before assignment
...
- local variable should be initialized before it is referenced by another variable
-
-
"""
