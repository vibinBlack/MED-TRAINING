...
def test_package_basic_import():
    ...
    except AttributeError : # Because 'package1' has no attribute 'module1'
        pass
...
def test_package_import_failure():
    ...
    why_it_failed = ''' package2 does not have __init__.py file, these kind of packages are called namespace packages.
...
def test_package_sub_packages():
    ...
    # both package1 and subpackage contains __init__.py files
    assert True == ("package1.subpackage.m1" in sys.modules)
