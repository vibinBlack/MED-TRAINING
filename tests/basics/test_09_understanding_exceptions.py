...
def test_missing_except():
    ...
    try:
        ...
        print(e)                 # 'str' object has no attribute 'missingmethod'
    result.append("two")
...
def function_with_except(result):
    ...
    result.append("f:return")              # [] => ['f:enter', 'f:except', 'f:return']
...
def function_without_except(result):
    ...
    try:
        ...
        print(e)                  # 'str' object has no attribute 'missingmethod'
    result.append("f:return")     # [] => ['f:enter', 'f:return']
...
def test_function_call_with_except():
    ...
    try:
        ...
        result.append("m:aftercall")   # ['m:beforecall', 'f:enter', 'f:except', 'f:return', 'm:aftercall']
    except AttributeError as ae:
...
def test_function_call_without_except():
    ...
    try:
        ...
        result.append("m:except")     # ['m:beforecall', 'f:enter', 'f:return', 'm:aftercall']
...
def test_else_on_exception():
    ...
    try:
        ...
        result.append("m:else")       # ['m:beforecall', 'f:enter', 'f:except', 'f:return', 'm:aftercall', 'm:else']
...
def test_else_on_no_exception():
    ...
    try:
        ...
        result.append("m:else")         # ['m:beforecall', 'f:enter', 'f:return', 'm:aftercall', 'm:else']
...
def test_finally_on_exception():
    ...
    try:
        ...
        result.append("m:finally")       # ['m:beforecall', 'f:enter', 'f:except', 'f:return', 'm:aftercall', 'm:else', 'm:finally']
...
def test_finally_on_no_exception():
    ...
    try:
        ...
        result.append("m:finally")      # ['m:beforecall', 'f:enter', 'f:return', 'm:aftercall', 'm:else', 'm:finally']
