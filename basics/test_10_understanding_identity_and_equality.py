...
def test_identity_equality_small_numbers():
    ...
    Python caches small integers for efficiency.When integers below 257 are created they are referenced to this cache
    and for integers greater than 256 new object references ar created.
    """
    a = b = 10
    assert True == (a is b)
    assert True == ( a == b)
...
-Integers below 257 behave differently than integers >=257
-"==" is used for checking values of both the operands 
